...
{
    public partial class ViewAgentOrderListForm : Form
    {
        private readonly IOrderRepository _orderRepository;
        private readonly IAccountRepository _accountRepository;
        private readonly IProductRepository _productRepository;
        private readonly IOrderRowRepository _orderRowRepository;
        public ViewAgentOrderListForm(IOrderRepository orderRepository, IAccountRepository accountRepository, IProductRepository productRepository, IOrderRowRepository orderRowRepository)
        {
        ...
        private void ViewOrderListForm_Load(object sender, EventArgs e)
        {
            loadData();
        }
